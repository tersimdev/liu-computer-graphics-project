...
void init(void)
{
    ...
    lights[0].color = vec4(0.9f, 0.9f, 0.8f, 2.0f);
...
Ans: World Space, since we multiply normals by a modified model matrix only.
If we multiplied by view/camera matrix, we would be in view space.
